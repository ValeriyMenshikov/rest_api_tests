...
class Fora(SQLModel, table=True):
    __tablename__ = "Fora"
    __table_args__ = (PrimaryKeyConstraint("ForumId", name="PK_Fora"),)
...
class TagGroups(SQLModel, table=True):
    ...
    __table_args__ = (PrimaryKeyConstraint("TagGroupId", name="PK_TagGroups"),)
...
class Users(SQLModel, table=True):
    __tablename__ = "Users"
    __table_args__ = (PrimaryKeyConstraint("UserId"),)
...
class EFMigrationsHistory(SQLModel, table=True):
    ...
    __table_args__ = (PrimaryKeyConstraint("MigrationId"),)
